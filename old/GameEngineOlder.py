...
try:
            ...
            for e in pygame.event.get():
                if e.type == pygame.KEYDOWN:
                    ...
                    if b not in self._buttons:
                        self._buttons[b] = self._ButtonData(
                            now,
                            e.pos,
                            True,
                            False
                    ...
                    self._other_events.append(Events.new(
                        Events.from_name(pygame.event.event_name(e.type)),
                        now,
                        **e.__dict__
                    ))
    ...
    class ArrayViewer(Game):
        ...
        def update(self, engine, input, t, dt):
            pygame.display.set_caption('{} TPS({}) FPS({})'.format(
                self.name,
                engine.tps_actual,
                engine.fps_actual
            ))
