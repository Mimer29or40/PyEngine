...
from . import events, get_tps, get_fps
from .input import Input, KeyData, ButtonData
    ...
    def get_events(self):
        ...
        for e in pygame.event.get():
            if e.type == pygame.KEYDOWN:
                ...
                self._other_events.append(events.Event(
