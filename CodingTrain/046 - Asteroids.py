...
class Laser:
    def __init__(self, ship):
        ...
        self.vel = ship.vel + Vector.from_angle(ship.heading) * 10.
    ...
    def off_screen(self):
        return (
            self.pos.x < 0 or engine.width < self.pos.x or
            self.pos.y < 0 or engine.height < self.pos.y
        )
