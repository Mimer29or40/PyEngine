...
class Vector2c(ABC):
    ...
    def astype(self, dtype: Type[DType], order="K", casting="unsafe", subok=True) -> Vector2: ...
    @property
    def x(self) -> DType: ...
    @property
    def y(self) -> DType: ...
...
class Vector3c(ABC):
    ...
    def astype(self, dtype: Type[DType], order="K", casting="unsafe", subok=True) -> Vector3: ...
    @property
    def x(self) -> DType: ...
    @property
    def y(self) -> DType: ...
...
class Vector4c(ABC):
    ...
    def astype(self, dtype: Type[DType], order="K", casting="unsafe", subok=True) -> Vector4: ...
    @property
    def x(self) -> DType: ...
    @property
    def y(self) -> DType: ...
