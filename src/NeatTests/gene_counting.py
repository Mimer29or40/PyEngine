...
if __name__ == "__main__":
    ...
    def setup(genome, node_inno, con_inno):
        ...
        cons = 5
        for _ in range(cons):
            con = Connection(con_inno[0].inc, 0, 0, 1.0, True)
        ...
        genome[0].add_node(Node(node_inno[0].inc, -1, NodeType.HIDDEN))
        genome[0].add_node(Node(node_inno[0].inc, -1, NodeType.HIDDEN))
        genome[0].add_connection(Connection(con_inno[0].inc, 0, 0, 1.0, True))
        genome[0].add_connection(Connection(con_inno[0].inc, 0, 0, 1.0, True))
        genome[0].add_connection(Connection(con_inno[0].inc, 0, 0, 1.0, True))
        ...
        genome[1].add_node(Node(node_inno[0].inc, -1, NodeType.HIDDEN))
        genome[1].add_node(Node(node_inno[0].inc, -1, NodeType.HIDDEN))
        genome[1].add_connection(Connection(con_inno[0].inc, 0, 0, 1.0, True))
        genome[1].add_connection(Connection(con_inno[0].inc, 0, 0, 1.0, True))
        genome[1].add_connection(Connection(con_inno[0].inc, 0, 0, 1.0, True))
